...
import 'package:mobil_projesi/GirisEkrani.dart';
...
/*Kodun devamı geçmiş kayıt ekranıyla aynı */
  ...
  void kayitOl() async {
    ...
    if (form!.validate()) {
      if (pass != cpass) {
        ...
        var user = await _authService.kayitOl(kad, em, pass);
        if (user != null) {
    ...
    return Scaffold(
      body: Container(
        ...
        child: SingleChildScrollView(
          child: Padding(
            padding: EdgeInsets.fromLTRB(5, MediaQuery.of(context).size.height * 0.05, 10, 0),
            child: Form(
              key: _formKey,
              child: Column(
                children: <Widget>[
